...
wof-tags: [knowledge, synthesizer]
wof-note: "Complements WOF orchestration - see WOF docs for multi-model delegation"
---

> **WOF Integration Note:** This agent complements WOF's multi-agent orchestration system. It works within a single provider's context while WOF's core roles (Orchestrator, Validator, Critic) handle cross-model delegation and independent verification.

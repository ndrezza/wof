...
export function registerSearchTools(server) {
    server.tool("search_code", "Search for code across repositories in a project", {
        ...
        try {
            ...
            if (!proj)
                throw new Error("projectId is required for code search");
    ...
    server.tool("search_wiki", "Search for content across wiki pages in a project", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
    ...
    server.tool("search_work_items", "Search for work items across projects in Azure DevOps", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),

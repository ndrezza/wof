...
export function registerPullRequestTools(server) {
    ...
    server.tool("create_pull_request", "Create a new pull request, including reviewers, linked work items, and optional tags", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),
    ...
    server.tool("update_pull_request", "Update an existing pull request", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),
        pullRequestId: z.number().describe("The ID of the pull request"),
    ...
    server.tool("get_pull_request_comments", "Get all comment threads on a pull request", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),
        pullRequestId: z.number().describe("The ID of the pull request"),
    ...
    server.tool("add_pull_request_comment", "Add a comment to a pull request (new thread or reply to existing)", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),
        pullRequestId: z.number().describe("The ID of the pull request"),
    ...
    server.tool("get_pull_request_changes", "Get the file changes in a pull request", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),
        pullRequestId: z.number().describe("The ID of the pull request"),
    ...
    server.tool("get_pull_request_checks", "Summarize the latest status checks and policy evaluations for a pull request", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),
        pullRequestId: z.number().describe("The ID of the pull request"),

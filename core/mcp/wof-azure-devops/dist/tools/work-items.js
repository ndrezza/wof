...
export function registerWorkItemTools(server) {
    server.tool("list_work_items", "List work items in a project using WIQL query or by IDs", {
    ...
    server.tool("get_work_item", "Get details of a specific work item", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
    ...
    server.tool("create_work_item", "Create a new work item", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
    ...
    server.tool("update_work_item", "Update an existing work item", {
    ...
    server.tool("manage_work_item_link", "Add or remove a link between two work items", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),

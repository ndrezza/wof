...
export function registerGitTools(server) {
    server.tool("get_file_content", "Get content of a file or directory from a repository", {
    ...
    server.tool("create_branch", "Create a new branch from an existing one. Pass plain branch names (no 'refs/heads/').", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),
    ...
    server.tool("create_commit", `Create a commit on an existing branch using file changes.
...
Provide changes as an array of objects with: changeType ("add", "edit", or "delete"), path, and content (for add/edit).`, {
    ...
    server.tool("list_commits", "List recent commits on a branch including file-level diff content for each commit", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),

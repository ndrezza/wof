...
export function registerRepositoryTools(server) {
    server.tool("list_repositories", "List all Git repositories in a project", {
    ...
    server.tool("get_repository_details", "Get detailed information about a repository including statistics and refs", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),
    ...
    server.tool("get_repository_tree", "Displays a hierarchical tree view of files and directories within a single repository", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        repositoryId: z.string().describe("The ID or name of the repository"),
    ...
    server.tool("get_all_repositories_tree", "Displays a hierarchical tree view of files and directories for all repositories in a project", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        depth: z.number().min(0).max(10).default(0).describe("Maximum depth to traverse (0 = unlimited)"),

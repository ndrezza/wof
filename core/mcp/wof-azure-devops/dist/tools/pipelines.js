...
export function registerPipelineTools(server) {
    server.tool("list_pipelines", "List pipelines in a project", {
    ...
    server.tool("get_pipeline", "Get details of a specific pipeline", {
        projectId: z.string().optional().describe("The ID or name of the project"),
    ...
    server.tool("list_pipeline_runs", "List recent runs for a pipeline", {
        projectId: z.string().optional().describe("The ID or name of the project"),
    ...
    server.tool("get_pipeline_run", "Get details for a specific pipeline run", {
        projectId: z.string().optional().describe("The ID or name of the project"),
    ...
    server.tool("download_pipeline_artifact", "Download a file from a pipeline run artifact and return its textual content", {
        projectId: z.string().optional().describe("The ID or name of the project"),
        runId: z.number().describe("Pipeline run identifier"),
    ...
    server.tool("pipeline_timeline", "Get the timeline (stages, jobs, tasks) for a pipeline run", {
        projectId: z.string().optional().describe("The ID or name of the project"),
        runId: z.number().describe("Pipeline run identifier"),
    ...
    server.tool("get_pipeline_log", "Get the log content for a specific log in a pipeline run", {
        projectId: z.string().optional().describe("The ID or name of the project"),
        runId: z.number().describe("Pipeline run identifier"),
    ...
    server.tool("trigger_pipeline", "Trigger a pipeline run", {
        projectId: z.string().optional().describe("The ID or name of the project"),

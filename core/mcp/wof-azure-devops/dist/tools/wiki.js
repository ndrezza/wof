...
export function registerWikiTools(server) {
    server.tool("get_wikis", "List all wikis in a project", {
    ...
    server.tool("get_wiki_page", "Get the content of a wiki page", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        ...
        try {
            ...
            return {
                content: [{ type: "text", text: page.content || JSON.stringify(page, null, 2) }],
            };
        }
        catch (err) {
            return {
    ...
    server.tool("list_wiki_pages", "List pages within an Azure DevOps wiki", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        wikiId: z.string().describe("The ID or name of the wiki"),
    ...
    server.tool("create_wiki", "Create a new wiki in a project", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
    ...
    server.tool("create_wiki_page", "Create a new page in a wiki", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        wikiId: z.string().describe("The ID or name of the wiki"),
    ...
    server.tool("update_wiki_page", "Update the content of an existing wiki page", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
        wikiId: z.string().describe("The ID or name of the wiki"),

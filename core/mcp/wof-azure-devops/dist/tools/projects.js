...
export function registerProjectTools(server) {
    server.tool("list_projects", "List all projects in an organization", {
    ...
    server.tool("get_project_details", "Get comprehensive details of a project including process, work item types, and teams", {
        organizationId: z.string().optional().describe("The ID or name of the organization"),
        projectId: z.string().optional().describe("The ID or name of the project"),
